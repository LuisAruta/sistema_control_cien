...
class IntervencionTecnicaUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'intervenciontecnica.numero_de_registro' => ['required', 'integer', new NumeroUnicoRegistro(['intervenciones_tecnicas', $this->request->get('intervenciontecnica')['id'], $this->request->get('intervenciontecnica')['delegacion_dependencia_id']])],
